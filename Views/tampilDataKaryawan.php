            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-x text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-3 ">ID Karyawan</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $data['idKaryawan'] ?></th>
                            <td class="px-4 py-3 "><?= $data['namaKaryawan'] ?></td>
                            ...
                            <button type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                <a href="dashboard.php?page=updateDataKaryawan&id=<?=$data['idKaryawan'] ?>">Edit</a>
                         </button>
                         ...
                         <a href="dashboard.php?page=deleteDataKaryawan&id=<?=$data['idKaryawan']?>">Delete</a>
                        </button>
                        </td>
                        </tr>
